...
For the third operation, A and B will become empty at the same time. For the fourth operation, 
B will become empty first. So the total probability of A becoming empty first plus half the probability 
    ...
    def soupServings(self, N: int) -> float:
        ...
        def dfs(a,b):
            if (a,b) in memo:
                return memo[(a,b)]
            if a<=0 or b<=0:
                return (a < b and 1) or (a == b and 0.5) or (b < a and 0)#NB
            memo[(a,b)]=0.25 * (dfs(a - 100, b) + dfs(a - 75, b - 25) + dfs(a - 50, b -50) + dfs(a - 25, b - 75))
            return memo[(a,b)]
        memo={}
        
        return N > 4800 and 1 or dfs(N,N) # N > 4800 and 1 不知道哪来的
